...
namespace shz
{
    ...
    bool MaterialInstance::SetTextureAsset(const char* textureName, const Handle<TextureAsset>& textureHandle, const char* /*debugPath*/)
    {
        ...
        m_TextureBindings[resIndex].TextureHandle = textureHandle;
        m_TextureBindings[resIndex].pRuntimeView = nullptr; // asset wins unless runtime view is set later
