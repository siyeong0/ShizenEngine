...
namespace shz
{
	...
	void SHZ_CALL_TYPE SerializedShaderImpl::QueryInterface(const INTERFACE_ID& IID, IObject** ppInterface)
	{
	...
	IShader* SerializedShaderImpl::GetDeviceShader(RENDER_DEVICE_TYPE Type) const
	{
		...
		return pCompiledShader ? pCompiledShader->GetDeviceShader() : nullptr;
	}
