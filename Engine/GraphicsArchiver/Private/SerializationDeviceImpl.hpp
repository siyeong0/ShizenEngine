...
#include "Engine/RHI/Public/RenderDeviceBase.hpp"
...
namespace shz
{
	...
	public:
		...
		virtual void SHZ_CALL_TYPE CreatePipelineResourceSignature(
		...
		virtual void SHZ_CALL_TYPE CreateGraphicsPipelineState(
		...
		virtual void SHZ_CALL_TYPE GetPipelineResourceBindings(
			const PipelineResourceBindingAttribs& Attribs,
			uint32& NumBindings,
			const PipelineResourceBinding*& pBindings) override final;

		virtual ARCHIVE_DEVICE_DATA_FLAGS SHZ_CALL_TYPE GetSupportedDeviceFlags() const override final
		{
	...
	private:
		static void GetPipelineResourceBindingsD3D11(const PipelineResourceBindingAttribs& Attribs, std::vector<PipelineResourceBinding>& ResourceBindings);
		static void GetPipelineResourceBindingsD3D12(const PipelineResourceBindingAttribs& Attribs, std::vector<PipelineResourceBinding>& ResourceBindings);
		static void GetPipelineResourceBindingsGL(const PipelineResourceBindingAttribs& Attribs, std::vector<PipelineResourceBinding>& ResourceBindings);
		static void GetPipelineResourceBindingsVk(const PipelineResourceBindingAttribs& Attribs, std::vector<PipelineResourceBinding>& ResourceBindings);
		static void GetPipelineResourceBindingsMtl(const PipelineResourceBindingAttribs& Attribs, std::vector<PipelineResourceBinding>& ResourceBindings, const uint32 MaxBufferArgs);
		static void GetPipelineResourceBindingsWebGPU(const PipelineResourceBindingAttribs& Attribs, std::vector<PipelineResourceBinding>& ResourceBindings);
