...
namespace shz
{
	...
	void SerializedPipelineStateImpl::CreateDefaultResourceSignature(
		DeviceType Type,
	...
	void SerializedShaderImpl::CreateShader(
		DeviceType Type,
	...
	void SerializedResourceSignatureImpl::CreateDeviceSignature(
		DeviceType Type,
