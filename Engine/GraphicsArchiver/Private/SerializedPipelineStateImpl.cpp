...
#include "Engine/RHI/Public/PSOSerializer.hpp"
...
#define VERIFY_PSO(Expr, ...)                     \
    ...
    {                                             \
		...
		void ValidatePipelineStateArchiveInfo(
			const PipelineStateCreateInfo& PSOCreateInfo,
...
#undef LOG_PSO_ERROR_AND_THROW
	...
	template <typename PSOCreateInfoType>
	void SerializedPipelineStateImpl::Initialize(
	...
	void SerializedPipelineStateImpl::SerializeShaderCreateInfo(DeviceType Type, const ShaderCreateInfo& CI)
	{
