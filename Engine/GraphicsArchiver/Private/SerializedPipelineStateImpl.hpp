...
namespace shz
{
	...
	public:
		...
		virtual uint32 SHZ_CALL_TYPE GetPatchedShaderCount(ARCHIVE_DEVICE_DATA_FLAGS DeviceType) const override final;

		virtual ShaderCreateInfo SHZ_CALL_TYPE GetPatchedShaderCreateInfo(ARCHIVE_DEVICE_DATA_FLAGS DataType, uint32 ShaderIndex) const override final;
