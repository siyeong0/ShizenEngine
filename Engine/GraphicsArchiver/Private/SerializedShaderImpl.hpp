...
namespace shz
{
	...
	public:
		...
		virtual const ShaderDesc& SHZ_CALL_TYPE GetDesc() const override final { return m_CreateInfo.Get().Desc; }
		...
		virtual SHADER_STATUS SHZ_CALL_TYPE GetStatus(bool WaitForCompletion) override final;
		virtual IShader* SHZ_CALL_TYPE      GetDeviceShader(RENDER_DEVICE_TYPE Type) const override final;
