...
#include "Engine/ShaderTools/Public/GLSLangUtils.hpp"
...
namespace shz
{
	...
	SerializationDeviceImpl::SerializationDeviceImpl(IReferenceCounters* pRefCounters, const SerializationDeviceCreateInfo& CreateInfo)
		...
		, m_ValidDeviceFlags{ shz::GetSupportedDeviceFlags() }
	{
	...
	void SerializationDeviceImpl::CreateShader(
	...
	void SerializationDeviceImpl::CreatePipelineResourceSignature(
	...
	void SerializationDeviceImpl::CreateSerializedResourceSignature(
		const PipelineResourceSignatureDesc& Desc,
		const ResourceSignatureArchiveInfo& ArchiveInfo,
	...
	void SerializationDeviceImpl::CreateGraphicsPipelineState(
	...
	void SerializationDeviceImpl::CreateComputePipelineState(
	...
	void SerializationDeviceImpl::CreateRayTracingPipelineState(
	...
	void SerializationDeviceImpl::CreateTilePipelineState(
	...
	void SerializationDeviceImpl::GetPipelineResourceBindings(
		const PipelineResourceBindingAttribs& Info,
		uint32& NumBindings,
	...
	PipelineResourceBinding SerializationDeviceImpl::ResDescToPipelineResBinding(
