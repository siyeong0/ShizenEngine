...
#pragma once
 ...
 // \file
 // Defines shz::ISerializedShader interface
...
namespace shz
{
	...
	struct SHZ_INTERFACE ISerializedShader : public IShader
	{
		...
		virtual IShader * GetDeviceShader(enum RENDER_DEVICE_TYPE DeviceType) const = 0;
	};
