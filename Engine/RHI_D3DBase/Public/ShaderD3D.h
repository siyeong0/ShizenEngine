...
#pragma once
 ...
 // \file
 // Definition of the shz::IShaderD3D interface and related data structures
...
namespace shz
{
	...
	struct HLSLShaderResourceDesc : public ShaderResourceDesc
	{
		// Shader register
	...
	struct SHZ_INTERFACE IShaderD3D : public IShader
	{
