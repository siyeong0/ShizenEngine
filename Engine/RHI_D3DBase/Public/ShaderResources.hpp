...
#pragma once
 ...
 // \file
 // Declaration of shz::ShaderResources class
...
namespace std
{
	...
	template <>
	struct hash<shz::D3DShaderResourceAttribs>
	{
		size_t operator()(const shz::D3DShaderResourceAttribs& Attribs) const
		{
	...
	template <>
	struct hash<shz::ShaderResources>
	{
		size_t operator()(const shz::ShaderResources& Res) const
		{
			return Res.GetHash();
		}
	};
