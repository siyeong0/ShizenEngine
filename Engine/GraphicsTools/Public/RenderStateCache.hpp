...
namespace shz
{
	...
	public:
		...
		RenderDeviceWithCache(IRenderDevice* pDevice, IRenderStateCache* pCache = nullptr) noexcept
			: TBase{ pDevice }
			, m_pCache{ pCache }
		{
		}
		...
		RenderDeviceWithCache(IRenderDevice* pDevice, const RenderStateCacheCreateInfo& CacheCI)
			:TBase{ pDevice }
		{
