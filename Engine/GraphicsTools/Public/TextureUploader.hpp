...
enum TEXTURE_UPLOADER_MODE : uint8
{
...
{
    // Texture uploader mode, see shz::TEXTURE_UPLOADER_MODE.
...
public:
    ...
    //                           see remarks.
    // \param [in]  Desc       - Buffer description, see shz::UploadBufferDesc.
    ...
    // Returns texture uploader statistics, see shz::TextureUploaderStats.
