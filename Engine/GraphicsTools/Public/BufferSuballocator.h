...
namespace shz
{
	...
	struct IBufferSuballocator : public IObject
	{
		...
		// Returns the suballocator usage stats, see shz::BufferSuballocatorUsageStats.
	...
	// \param[in]  CreateInfo           - Suballocator create info, see shz::BufferSuballocatorCreateInfo.
	// \param[in]  ppBufferSuballocator - Memory location where pointer to the buffer suballocator will be stored.
	void CreateBufferSuballocator(
