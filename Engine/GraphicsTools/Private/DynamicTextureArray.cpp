...
namespace shz
{
	...
	void DynamicTextureArray::CommitResize(IRenderDevice* pDevice, IDeviceContext* pContext, bool AllowNull)
	{
	...
	ITexture* DynamicTextureArray::Resize(
	...
	ITexture* DynamicTextureArray::Update(IRenderDevice* pDevice, IDeviceContext* pContext)
	{
