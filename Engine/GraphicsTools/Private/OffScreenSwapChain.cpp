...
#include "Engine/RHI/Public/SwapChainBase.hpp"
...
namespace shz
{
	...
	public:
		...
		virtual void SHZ_CALL_TYPE Present(uint32 SyncInterval) override
		{
		...
		virtual ITextureView* SHZ_CALL_TYPE GetDepthBufferDSV() override final
		{
			return m_pDSV;
		}
