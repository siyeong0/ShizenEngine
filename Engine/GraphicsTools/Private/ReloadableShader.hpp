...
#pragma once
 ...
 // \file
 // Definition of the shz::ReloadableShader class
...
namespace shz
{
	...
	public:
		...
		virtual const ShaderDesc& SHZ_CALL_TYPE GetDesc() const override final
		{
		...
		virtual void SHZ_CALL_TYPE GetBytecode(const void** ppBytecode, uint64& Size) const override final
		{
