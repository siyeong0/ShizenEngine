...
#include "Engine/GraphicsArchiver/Public/ArchiverFactory.h"

#include "Engine/RHI/Public/PipelineStateBase.hpp"
#include "Engine/Core/Common/Public/RefCntAutoPtr.hpp"
#include "Engine/GraphicsArchiver/Public/SerializationDevice.h"
#include "Engine/GraphicsArchiver/Public/SerializedShader.h"
#include "Engine/Core/Common/Public/CallbackWrapper.hpp"
...
namespace shz
{
	...
	RenderStateCacheImpl::RenderStateCacheImpl(IReferenceCounters* pRefCounters, const RenderStateCacheCreateInfo& CreateInfo)
		: TBase{ pRefCounters }
...
#define RENDER_STATE_CACHE_LOG(Level, ...)                         \
	...
	bool RenderStateCacheImpl::CreateShader(const ShaderCreateInfo& ShaderCI, IShader** ppShader)
	{
		if (ppShader == nullptr)
		{
	...
	template <typename CreateInfoType>
	bool RenderStateCacheImpl::CreatePipelineState(const CreateInfoType& PSOCreateInfo, IPipelineState** ppPipelineState)
	{
...
extern "C"
{
	void CreateRenderStateCache(const shz::RenderStateCacheCreateInfo& CreateInfo,
		shz::IRenderStateCache** ppCache)
	{
		shz::CreateRenderStateCache(CreateInfo, ppCache);
	}
}
