...
namespace shz
{
	...
	BasicFileStream::BasicFileStream(IReferenceCounters* pRefCounters, const Char* Path, EFileAccessMode Access /* = EFileAccessMode::Read*/)
		: TBase(pRefCounters)
	...
	void BasicFileStream::ReadBlob(shz::IDataBlob* pData)
	{
