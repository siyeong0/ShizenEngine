...
extern "C"
{
	void Shizen_ComputeImageDifference(const shz::ComputeImageDifferenceAttribs& Attribs,
		shz::ImageDiffInfo& ImageDiff)
	{
		shz::ComputeImageDifference(Attribs, ImageDiff);
	}
}
