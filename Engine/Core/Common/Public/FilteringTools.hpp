...
namespace shz
{
	...
	// Returns linear texture filter sample info, see shz::LinearTexFilterSampleInfo.
	//
	// \tparam AddressMode       - Texture addressing mode, see shz::TEXTURE_ADDRESS_MODE.
	// \tparam IsNormalizedCoord - Whether sample coordinate is normalized.
	//
	// \param [in] Width    - Texture width.
	// \param [in] u        - Texture sample coordinate.
	// \return                Linear texture filter sample information, see shz::LinearTexFilterSampleInfo.
