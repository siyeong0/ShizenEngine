...
#define NEW_RC_OBJ(Allocator, Desc, Type, ...) shz::MakeNewRCObj<Type, typename std::remove_reference<decltype(Allocator)>::type>(Allocator, Desc, __FILE__, __LINE__, ##__VA_ARGS__)
