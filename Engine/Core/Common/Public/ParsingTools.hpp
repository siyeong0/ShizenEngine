...
namespace shz
{
	...
	namespace Parsing
	{
		...
		IteratorType SkipDelimitersAndComments(
...
#undef CHECK_END
		...
		ContainerType Tokenize(
			const IteratorType& SourceStart,
...
#undef SINGLE_CHAR_TOKEN
		...
		//             if none is found.
		template <typename TokenIterType>
		TokenIterType FindMatchingBracket(
			const TokenIterType& Start,
