...
namespace shz
{
	...
	public:
		...
		ProxyDataBlob(IReferenceCounters* pRefCounters, void* pData, size_t Size, IObject* pDataContainer = nullptr)
			: TBase{ pRefCounters }
			, m_pData{ pData }
			, m_pConstData{ pData }
			, m_Size{ Size }
		...
		ProxyDataBlob(IReferenceCounters* pRefCounters, const void* pData, size_t Size, IObject* pDataContainer = nullptr)
			: TBase{ pRefCounters }
			, m_pData{ nullptr }
			, m_pConstData{ pData }
			, m_Size{ Size }
		...
		virtual size_t SHZ_CALL_TYPE GetSize() const override
		{
			return m_Size;
		}
