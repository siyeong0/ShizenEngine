...
namespace shz
{
	...
	{
	public:
		using TBase = ObjectBase<IFileStream>;
		...
		virtual void SHZ_CALL_TYPE ReadBlob(IDataBlob* pData) override final;

		// Reads data from the stream
		virtual bool SHZ_CALL_TYPE Read(void* Data, size_t Size) override final;

		// Writes data to the stream
		virtual bool SHZ_CALL_TYPE Write(const void* Data, size_t Size) override final;

		virtual size_t SHZ_CALL_TYPE GetSize() override final;

		virtual size_t SHZ_CALL_TYPE GetPos() override;

		virtual bool SHZ_CALL_TYPE SetPos(size_t Offset, int Origin) override;

		virtual bool SHZ_CALL_TYPE IsValid() override final;
