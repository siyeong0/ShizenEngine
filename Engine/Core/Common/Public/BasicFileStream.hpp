...
namespace shz
{
	...
	public:
		...
		virtual void SHZ_CALL_TYPE ReadBlob(IDataBlob* pData) override;

		// Reads data from the stream
		virtual bool SHZ_CALL_TYPE Read(void* Data, size_t Size) override;

		// Writes data to the stream
		virtual bool SHZ_CALL_TYPE Write(const void* Data, size_t Size) override;

		virtual size_t SHZ_CALL_TYPE GetSize() override;

		virtual size_t SHZ_CALL_TYPE GetPos() override;

		virtual bool SHZ_CALL_TYPE SetPos(size_t Offset, int Origin) override;

		virtual bool SHZ_CALL_TYPE IsValid() override;
