...
namespace shz
{
	...
	{
		// The geometry primitive type, see shz::GEOMETRY_PRIMITIVE_TYPE.
		...
		// see shz::GEOMETRY_PRIMITIVE_VERTEX_FLAGS.
	...
	struct CubeGeometryPrimitiveAttributes : public GeometryPrimitiveAttributes
	{
		...
		explicit CubeGeometryPrimitiveAttributes(
			float _Size = 1,
			GEOMETRY_PRIMITIVE_VERTEX_FLAGS _VertexFlags = GEOMETRY_PRIMITIVE_VERTEX_FLAG_ALL,
			uint32 _NumSubdivision = 1) noexcept
	...
	//                           For example, if VertexFlags = shz::GEOMETRY_PRIMITIVE_VERTEX_FLAG_POS_NORM, the vertex data will
