...
namespace shz
{
    ...
    InputControllerWin64::InputControllerWin64()
    {
        UpdateMousePos();
    }

    const MouseState& InputControllerWin64::GetMouseState()
    {
        UpdateMousePos();
        return InputControllerBase::GetMouseState();
    }

    bool InputControllerWin64::HandleNativeMessage(const void* MsgData)
    {
    ...
    void InputControllerWin64::UpdateMousePos()
    {
        POINT MousePosition;
