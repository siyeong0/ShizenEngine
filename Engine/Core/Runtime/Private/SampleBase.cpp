...
namespace shz
{
    ...
    void SampleBase::ModifyEngineInitInfo(const ModifyEngineInitInfoAttribs& Attribs)
    {
        ...
        case RENDER_DEVICE_TYPE_D3D12:
        {
            ...
            EngineD3D12CI.GPUDescriptorHeapDynamicSize[0] = 65536;
            EngineD3D12CI.GPUDescriptorHeapSize[0] = 65536;
            EngineD3D12CI.GPUDescriptorHeapDynamicSize[1] = 2048;
            EngineD3D12CI.DynamicDescriptorAllocationChunkSize[0] = 1024;
            EngineD3D12CI.DynamicDescriptorAllocationChunkSize[1] = 64; // D3D12_DESCRIPTOR_HEAP_TYPE_SAMPLER
        }
        break;
#endif
        default:
