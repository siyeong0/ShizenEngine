...
namespace shz
{
	...
	{
		return float3{ LinearToGamma(RGB.x), LinearToGamma(RGB.y), LinearToGamma(RGB.z) };
	}

	inline float3 LinearToSRGB(const float4& RGB)
	{
		return float3{ LinearToGamma(RGB.x), LinearToGamma(RGB.y), LinearToGamma(RGB.z) };
	}
	...
	{
		return float4{ LinearToGamma(RGBA.x), LinearToGamma(RGBA.y), LinearToGamma(RGBA.z), RGBA.w };
	}
	...
	{
		return float3{ FastLinearToGamma(RGB.x), FastLinearToGamma(RGB.y), FastLinearToGamma(RGB.z) };
	}
	...
	{
		return float4{ FastLinearToGamma(RGBA.x), FastLinearToGamma(RGBA.y), FastLinearToGamma(RGBA.z), RGBA.w };
	}
	...
	{
		return float3{ GammaToLinear(SRGB.x), GammaToLinear(SRGB.y), GammaToLinear(SRGB.z) };
	}
	...
	{
		return float4{ GammaToLinear(SRGBA.x), GammaToLinear(SRGBA.y), GammaToLinear(SRGBA.z), SRGBA.w };
	}
	...
	{
		return float3{ FastGammaToLinear(SRGB.x), FastGammaToLinear(SRGB.y), FastGammaToLinear(SRGB.z) };
	}
	...
	{
		return float4{ FastGammaToLinear(SRGBA.x), FastGammaToLinear(SRGBA.y), FastGammaToLinear(SRGBA.z), SRGBA.w };
	}
