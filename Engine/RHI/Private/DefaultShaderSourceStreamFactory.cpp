...
namespace shz
{
	...
	void DefaultShaderSourceStreamFactory::CreateInputStream(const Char* Name, IFileStream** ppStream)
	{
		CreateInputStream2(Name, CREATE_SHADER_SOURCE_INPUT_STREAM_FLAG_NONE, ppStream);
	}

	void DefaultShaderSourceStreamFactory::CreateInputStream2(const Char* Name, CREATE_SHADER_SOURCE_INPUT_STREAM_FLAGS Flags, IFileStream** ppStream)
	{
