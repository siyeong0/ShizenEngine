...
#undef CHECK_UNPACK_RENDER_PASS_PARAM
	...
	RefCntAutoPtr<IShader> DearchiverBase::UnpackShader(const ShaderCreateInfo& ShaderCI, IRenderDevice* pDevice)
	{
	...
	template <typename CreateInfoType>
	bool DearchiverBase::UnpackPSOShaders(
		ArchiveData& Archive,
	...
	static bool ModifyPipelineStateCreateInfo(PSOCreateInfoType& CreateInfo, const PipelineStateUnpackInfo& UnpackInfo)
	{
	...
	static bool ModifyShaderDesc(ShaderDesc& Desc, const ShaderUnpackInfo& UnpackInfo)
	{
	...
	void DearchiverBase::UnpackShader(const ShaderUnpackInfo& UnpackInfo, IShader** ppShader)
	{
	...
	void DearchiverBase::UnpackResourceSignature(const ResourceSignatureUnpackInfo& DeArchiveInfo, IPipelineResourceSignature** ppSignature)
	{
