...
void VerifyEngineCreateInfo(const EngineCreateInfo& EngineCI, const GraphicsAdapterInfo& AdapterInfo) noexcept(false)
{
    ...
    {
        LOG_ERROR_AND_THROW("Diligent Engine runtime (", SHZ_API_VERSION, ") is not compatible with the client API version (", EngineCI.EngineAPIVersion, ")");
    }
    ...
    std::array<uint32, MAX_ADAPTER_QUEUES> QueueCount = {};
