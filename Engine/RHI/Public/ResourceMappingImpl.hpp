...
#pragma once
 ...
 // \file
 // Declaration of the shz::ResourceMappingImpl class
...
namespace shz
{
	...
	{
	public:
		using TObjectBase = ObjectBase<IResourceMapping>;
		...
		virtual void SHZ_CALL_TYPE AddResource(const Char* Name, IDeviceObject* pObject, bool bIsUnique) override final;

		// Implementation of IResourceMapping::AddResourceArray()
		virtual void SHZ_CALL_TYPE AddResourceArray(
			const Char* Name,
			uint32                StartIndex,
		...
		virtual void SHZ_CALL_TYPE RemoveResourceByName(const Char* Name, uint32 ArrayIndex) override final;

		// Implementation of IResourceMapping::GetResource()
		virtual IDeviceObject* SHZ_CALL_TYPE GetResource(const Char* Name,
