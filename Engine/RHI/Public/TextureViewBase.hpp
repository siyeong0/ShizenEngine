...
#pragma once
 ...
 // \file
 // Implementation of the shz::TextureViewBase template class
...
namespace shz
{
	...
	public:
		...
		virtual void SHZ_CALL_TYPE SetSampler(ISampler* pSampler) override final
		{
#ifdef SHZ_DEBUG
		...
		virtual ISampler* SHZ_CALL_TYPE GetSampler() override final
		{
			return m_pSampler;
		}
		...
		virtual ITexture* SHZ_CALL_TYPE GetTexture() override final
		{
			return m_pTexture;
		}

		const ITexture* SHZ_CALL_TYPE GetTexture() const
		{
			return m_pTexture;
		}
