...
#pragma once
 ...
 // \file
 // Implementation of the shz::BottomLevelASBase template class

#include <unordered_map>
#include <atomic>

#include "Engine/RHI/Interface/IBottomLevelAS.h"
...
namespace shz
{
	...
	void CopyBLASGeometryDesc(
		const BottomLevelASDesc& SrcDesc,
	...
	class BottomLevelASBase
		: public DeviceObjectBase<typename EngineImplTraits::BottomLevelASInterface
	...
	public:
		...
		virtual ScratchBufferSizes SHZ_CALL_TYPE GetScratchBufferSizes() const override final
		{
		...
		virtual uint32 SHZ_CALL_TYPE GetActualGeometryCount() const override final
		{
