...
#pragma once
 ...
 // \file
 // Implementation of the shz::RenderPassBase template class
...
namespace shz
{
	...
	void ValidateRenderPassDesc(const RenderPassDesc& Desc, const RenderDeviceInfo& DeviceInfo, const GraphicsAdapterInfo& AdapterInfo) noexcept(false);
