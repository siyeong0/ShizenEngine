...
#pragma once
 ...
 // \file
 // Implementation of the shz::DeviceObjectArchive class
...
namespace shz
{
	...
	public:
		...
		struct ArchiveHeader
		{
			...
			uint32      APIVersion = SHZ_API_VERSION;
		...
		{
			NamedResourceKey(ResourceType _Type, const char* _Name, bool CopyName = false) noexcept
				: Type{ _Type }
				, Name{ _Name, CopyName }
			{
			}
