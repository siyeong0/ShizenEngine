...
#pragma once
 ...
 // \file
 // Implementation of the shz::TopLevelASBase template class
...
namespace shz
{
	...
	public:
		...
		bool SetInstanceData(
			const TLASBuildInstanceData* pInstances,
		...
		virtual TLASBuildInfo SHZ_CALL_TYPE GetBuildInfo() const override final
		{
			return m_BuildInfo;
		}
