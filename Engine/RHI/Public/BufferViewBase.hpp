...
#pragma once
 ...
 // \file
 // Implementation of the shz::BufferViewBase template class
...
namespace shz
{
	...
	class BufferViewBase
		: public DeviceObjectBase<typename EngineImplTraits::BufferViewInterface
		, typename EngineImplTraits::RenderDeviceImplType, BufferViewDesc>
	{
	public:
		...
		virtual IBuffer* SHZ_CALL_TYPE GetBuffer() const override final
		{
			return m_pBuffer;
		}
