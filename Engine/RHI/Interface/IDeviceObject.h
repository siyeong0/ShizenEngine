...
#pragma once
 ...
 // \file
 // Defines shz::IDeviceObject interface
...
namespace shz
{
	...
	// Base interface for all objects created by the render device shz::IRenderDevice
	struct SHZ_INTERFACE IDeviceObject : public IObject
	{
