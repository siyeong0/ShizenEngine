...
namespace shz
{
	...
	struct RenderTargetBlendDesc
	{
		...
		// Default value: shz::BLEND_OPERATION_ADD.
		...
		// Default value: shz::LOGIC_OP_NOOP.
		LOGIC_OPERATION LogicOp = LOGIC_OP_NOOP;

		// Render target write mask.
		// Default value: shz::COLOR_MASK_ALL.
	...
	struct BlendStateDesc
	{
		...
		// 
		// NB: when adding new members, don't forget to update std::hash<shz::BlendStateDesc>
		//
