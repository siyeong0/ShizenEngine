...
namespace shz
{
	...
	static constexpr uint32 MAX_LAYOUT_ELEMENTS = 16;
	// Compute layout element offset automatically, see shz::LayoutElement::RelativeOffset for details.
	static constexpr uint32 LAYOUT_ELEMENT_AUTO_OFFSET = 0xFFFFFFFFU;
	// Compute layout element stride automatically, see Diligen::LayoutElement::Stride for details.
	static constexpr uint32 LAYOUT_ELEMENT_AUTO_STRIDE = 0xFFFFFFFFU;

	// Input frequency
	enum INPUT_ELEMENT_FREQUENCY : uint8
	{
	...
	struct LayoutElement
	{
		...
		// Type of the element components, see shz::VALUE_TYPE for details.
		...
		// Frequency of the input data, see shz::INPUT_ELEMENT_FREQUENCY for details.
	...
	struct InputLayoutDesc
	{
		...
		constexpr InputLayoutDesc(const LayoutElement* _LayoutElements, uint32 _NumElements) noexcept
