...
#pragma once
 ...
 // \file
 // Defines shz::IFence interface and related data structures
...
namespace shz
{
	...
	enum FENCE_TYPE : uint8
	{
		...
		//
		// If NativeFence feature is enabled (see shz::DeviceFeatures), the fence may also be used for:
	...
	// Fence description
	struct FenceDesc : public DeviceObjectAttribs
	{
		// Fence type, see shz::FENCE_TYPE.
	...
	struct SHZ_INTERFACE IFence : public IDeviceObject
	{
		...
		// are complete.
		//
		// \note  The fence must have been created with type shz::FENCE_TYPE_GENERAL.
