...
namespace shz
{
	...
	// It is used by shz::StencilOpDesc structure to describe the stencil fail, depth fail
	...
	// It is used by shz::DepthStencilStateDesc structure to describe the stencil
	// operations for the front and back facing polygons.
	struct StencilOpDesc
	{
		// The stencil operation to perform when stencil testing fails.
		// Default value: shz::STENCIL_OP_KEEP.
		...
		// Default value: shz::COMPARISON_FUNC_ALWAYS. See shz::COMPARISON_FUNCTION.
		COMPARISON_FUNCTION StencilFunc = COMPARISON_FUNC_ALWAYS;

		// 
		// NB: when adding new members, don't forget to update std::hash<shz::StencilOpDesc>
		//
	...
	struct DepthStencilStateDesc
	{
		...
		// See shz::COMPARISON_FUNCTION for details.
		// Default value: shz::COMPARISON_FUNC_LESS.
		...
		// Identify stencil operations for the front-facing triangles, see shz::StencilOpDesc.
		StencilOpDesc FrontFace;

		// Identify stencil operations for the back-facing triangles, see shz::StencilOpDesc.
		StencilOpDesc BackFace;

		// 
		// NB: when adding new members, don't forget to update std::hash<shz::DepthStencilStateDesc>
		//
