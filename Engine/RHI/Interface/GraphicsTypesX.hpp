...
namespace shz
{
	...
	// C++ wrapper over shz::SubpassDesc struct.
	struct SubpassDescX
	{
	...
	// C++ wrapper over shz::RenderPassDesc.
	...
	struct PipelineResourceSignatureDescX : DeviceObjectAttribsX<PipelineResourceSignatureDescX, PipelineResourceSignatureDesc>
	{
		...
		PipelineResourceSignatureDescX(
			const std::initializer_list<PipelineResourceDesc>& _Resources,
	...
	struct PipelineResourceLayoutDescX : PipelineResourceLayoutDesc
	{
		...
		PipelineResourceLayoutDescX(
			const std::initializer_list<ShaderResourceVariableDesc>& _Vars,
			const std::initializer_list<ImmutableSamplerDesc>& _ImtblSamplers)
			: VarCopy{ _Vars }
			, ImtblSamCopy{ _ImtblSamplers }
		{
	...
	struct BottomLevelASDescX : DeviceObjectAttribsX<BottomLevelASDescX, BottomLevelASDesc>
	{
		...
		BottomLevelASDescX(
			const std::initializer_list<BLASTriangleDesc>& _Triangles,
	...
	struct RayTracingPipelineStateCreateInfoX : PipelineStateCreateInfoX<RayTracingPipelineStateCreateInfoX, RayTracingPipelineStateCreateInfo>
	{
		...
		RayTracingPipelineStateCreateInfoX(
			const std::initializer_list<RayTracingGeneralShaderGroup>& _GeneralShaders,
	...
	public:
		...
		MultiDrawAttribsX(
			const std::initializer_list<MultiDrawItem>& DrawItems,
			DRAW_FLAGS Flags,
	...
	public:
		...
		MultiDrawIndexedAttribsX(
			const std::initializer_list<MultiDrawIndexedItem>& DrawItems,
