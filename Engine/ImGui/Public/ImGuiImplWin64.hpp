...
class ImGuiImplWin64 final : public ImGuiImplShizen
{
public:
    static std::unique_ptr<ImGuiImplWin64> Create(const ImGuiShizenCreateInfo& CI, HWND hWnd);

    ImGuiImplWin64(const ImGuiShizenCreateInfo& CI, HWND hWnd);
    ~ImGuiImplWin64();
