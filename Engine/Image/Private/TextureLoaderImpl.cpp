/*
 *  Copyright 2019-2025 shz Graphics LLC
...
#include "Engine/Image/Public/PNGCodec.h"
#include "Engine/Image/Public/JPEGCodec.h"
...
namespace shz
{
	...
	TextureLoaderImpl::TextureLoaderImpl(
	...
	void TextureLoaderImpl::CreateTexture(IRenderDevice* pDevice, ITexture** ppTexture)
	{
	...
	void CreateTextureLoaderFromFile(
		const char* FilePath,
	...
	void CreateTextureLoaderFromMemory(
		const void* pData,
		size_t Size,
		bool MakeDataCopy,
		const TextureLoadInfo& TexLoadInfo,
	...
	void CreateTextureLoaderFromDataBlob(
		RefCntAutoPtr<IDataBlob> pDataBlob,
		const TextureLoadInfo& TexLoadInfo,
		ITextureLoader** ppLoader)
	{
