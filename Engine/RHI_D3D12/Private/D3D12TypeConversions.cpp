...
#include "Engine/RHI_D3DBase/Public/D3DTypeConversionImpl.hpp"
#include "Engine/RHI_D3DBase/Public/D3DViewDescConversionImpl.hpp"
...
#   endif
	...
	{
		return IsPowerOfTwo(Stages) ? ShaderTypeToD3D12ShaderVisibility(Stages) : D3D12_SHADER_VISIBILITY_ALL;
	}
