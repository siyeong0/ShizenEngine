...
#pragma once
 ...
 // \file
 // Declaration of shz::DeviceMemoryD3D12Impl class

#include "EngineD3D12ImplTraits.hpp"
#include "Engine/RHI/Public/DeviceMemoryBase.hpp"
...
namespace shz
{
	...
	public:
		...
		DeviceMemoryD3D12Impl(IReferenceCounters* pRefCounters, RenderDeviceD3D12Impl* pDeviceD3D11, const DeviceMemoryCreateInfo& MemCI);
		...
		virtual bool SHZ_CALL_TYPE Resize(uint64 NewSize) override final;

		// Implementation of IDeviceMemory::GetCapacity().
		virtual uint64 SHZ_CALL_TYPE GetCapacity() const override final;

		// Implementation of IDeviceMemory::IsCompatible().
		virtual bool SHZ_CALL_TYPE IsCompatible(IDeviceObject* pResource) const override final;

		// Implementation of IDeviceMemoryD3D12::GetRange().
		virtual DeviceMemoryRangeD3D12 SHZ_CALL_TYPE GetRange(uint64 Offset, uint64 Size) const override final;

		// Implementation of IDeviceMemoryD3D12::IsUsingNVApi().
		virtual bool SHZ_CALL_TYPE IsUsingNVApi() const override final { return m_UseNVApi; }
