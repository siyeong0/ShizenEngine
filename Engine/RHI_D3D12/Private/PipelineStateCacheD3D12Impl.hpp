...
#pragma once
 ...
 // \file
 // Declaration of shz::PipelineStateCacheD3D12Impl class

#include "EngineD3D12ImplTraits.hpp"
#include "Engine/RHI/Public/PipelineStateCacheBase.hpp"
...
namespace shz
{
	...
	public:
		...
		PipelineStateCacheD3D12Impl(IReferenceCounters* pRefCounters, RenderDeviceD3D12Impl* pDevice, const PipelineStateCacheCreateInfo& CreateInfo);
		...
		virtual void SHZ_CALL_TYPE GetData(IDataBlob** ppBlob) override final;
