...
#pragma once
 ...
 // \file
 // Declaration of shz::SwapChainD3D12Impl class

#include "Platforms/Win64/Public/WinHPreface.h"
#include <dxgi1_4.h>
#include "Platforms/Win64/Public/WinHPostface.h"

#include "ISwapChainD3D12.h"
#include "Engine/RHI_D3DBase/Public/SwapChainD3DBase.hpp"
...
namespace shz
{
	...
	public:
		...
		virtual void SHZ_CALL_TYPE Present(uint32 SyncInterval) override final;

		// Implementation of ISwapChain::Resize() in Direct3D12 backend.
		virtual void SHZ_CALL_TYPE Resize(uint32 NewWidth, uint32 NewHeight, SURFACE_TRANSFORM NewPreTransform) override final;

		// Implementation of ISwapChainD3D12::GetDXGISwapChain().
		virtual IDXGISwapChain* SHZ_CALL_TYPE GetDXGISwapChain() override final { return m_pSwapChain; }
		...
		virtual ITextureViewD3D12* SHZ_CALL_TYPE GetDepthBufferDSV() override final { return m_pDepthBufferDSV; }
