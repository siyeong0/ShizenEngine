...
#pragma once
 ...
 // \file
 // Declaration of shz::FenceD3D12Impl class

#include "EngineD3D12ImplTraits.hpp"
#include "Engine/RHI/Public/FenceBase.hpp"
...
namespace shz
{
	...
	public:
		...
		virtual uint64 SHZ_CALL_TYPE GetCompletedValue() override final;

		// Implementation of IFence::Signal() in Direct3D12 backend.
		virtual void SHZ_CALL_TYPE Signal(uint64 Value) override final;

		// Implementation of IFenceD3D12::Wait() in Direct3D12 backend.
		virtual void SHZ_CALL_TYPE Wait(uint64 Value) override final;

		// Implementation of IFenceD3D12::GetD3D12Fence().
		virtual ID3D12Fence* SHZ_CALL_TYPE GetD3D12Fence() override final { return m_pd3d12Fence; }
