...
// \file
// Declaration of shz::TextureD3D12Impl class

#include "EngineD3D12ImplTraits.hpp"
#include "Engine/RHI/Public/TextureBase.hpp"
...
namespace shz
{
	...
	public:
		...
		virtual ID3D12Resource* SHZ_CALL_TYPE GetD3D12Texture() const override final { return GetD3D12Resource(); }

		// Implementation of ITexture::GetNativeHandle() in Direct3D12 backend.
		virtual uint64 SHZ_CALL_TYPE GetNativeHandle() override final { return BitCast<uint64>(GetD3D12Texture()); }
