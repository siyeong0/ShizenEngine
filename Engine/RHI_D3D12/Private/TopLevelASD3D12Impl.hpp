...
#pragma once
 ...
 // \file
 // Declaration of shz::TopLevelASD3D12Impl class

#include "EngineD3D12ImplTraits.hpp"
#include "Engine/RHI/Public/TopLevelASBase.hpp"
...
namespace shz
{
	...
	public:
		...
		virtual ID3D12Resource* SHZ_CALL_TYPE GetD3D12TLAS() override final { return GetD3D12Resource(); }

		// Implementation of ITopLevelASD3D12::GetNativeHandle() in Direct3D12 backend.
		virtual uint64 SHZ_CALL_TYPE GetNativeHandle() override final { return BitCast<uint64>(GetD3D12TLAS()); }
		...
		virtual D3D12_CPU_DESCRIPTOR_HANDLE SHZ_CALL_TYPE GetCPUDescriptorHandle() override final
		{
