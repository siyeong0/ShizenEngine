...
#pragma once
 ...
 // \file
 // Declaration of shz::PipelineResourceSignatureD3D12Impl class

#include <array>

#include "EngineD3D12ImplTraits.hpp"
#include "PipelineResourceAttribsD3D12.hpp"
#include "Engine/RHI/Public/PipelineResourceSignatureBase.hpp"
#include "Engine/GraphicsUtils/Public/SRBMemoryAllocator.hpp"
#include "RootParamsManager.hpp"
#include "Engine/ShaderTools/Public/ResourceBindingMap.hpp"
...
namespace shz
{
	...
	public:
		...
		{
			ASSERT(ShaderRegister == _ShaderRegister, "Shader register (", _ShaderRegister, ") exceeds maximum representable value");
			ASSERT(RegisterSpace == _RegisterSpace, "Shader register space (", _RegisterSpace, ") exceeds maximum representable value");
		}
	...
	// Implementation of the shz::PipelineResourceSignatureD3D12Impl class
	...
	public:
		...
		bool DvpValidateCommittedResource(
			const DeviceContextD3D12Impl* pDeviceCtx,
