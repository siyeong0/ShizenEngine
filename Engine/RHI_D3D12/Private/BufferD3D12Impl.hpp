...
#pragma once
 ...
 // \file
 // Declaration of shz::BufferD3D12Impl class

#include "EngineD3D12ImplTraits.hpp"
#include "Engine/RHI/Public/BufferBase.hpp"
#include "BufferViewD3D12Impl.hpp" // Required by BufferBase
#include "D3D12ResourceBase.hpp"
#include "D3D12DynamicHeap.hpp"
#include "DescriptorHeap.hpp"
#include "Engine/RHI/Public/IndexWrapper.hpp"
...
namespace shz
{
	...
	public:
		...
		virtual ID3D12Resource* SHZ_CALL_TYPE GetD3D12Buffer(uint64& DataStartByteOffset, IDeviceContext* pContext) override final;
		...
		virtual void SHZ_CALL_TYPE SetD3D12ResourceState(D3D12_RESOURCE_STATES state) override final;

		// Implementation of IBufferD3D12::GetD3D12ResourceState().
		virtual D3D12_RESOURCE_STATES SHZ_CALL_TYPE GetD3D12ResourceState() const override final;

		// Implementation of IBuffer::GetSparseProperties().
		virtual SparseBufferProperties SHZ_CALL_TYPE GetSparseProperties() const override final;
