...
#pragma once
 ...
 // \file
 // Declaration of shz::ShaderBindingTableD3D12Impl class

#include "EngineD3D12ImplTraits.hpp"
#include "Engine/RHI/Public/ShaderBindingTableBase.hpp"
...
namespace shz
{
	...
	public:
		...
		virtual const D3D12_DISPATCH_RAYS_DESC& SHZ_CALL_TYPE GetD3D12BindingTable() const override final { return m_d3d12DispatchDesc; }

		using BindingTable = TShaderBindingTableBase::BindingTable;
		void GetData(
			BufferD3D12Impl*& pSBTBufferD3D12,
