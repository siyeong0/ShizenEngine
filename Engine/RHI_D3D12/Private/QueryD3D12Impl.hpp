...
#pragma once
 ...
 // \file
 // Declaration of shz::QueryD3D12Impl class

#include <array>

#include "EngineD3D12ImplTraits.hpp"
#include "Engine/RHI/Public/QueryBase.hpp"
...
namespace shz
{
	...
	public:
		...
		virtual bool SHZ_CALL_TYPE GetData(void* pData, uint32 DataSize, bool AutoInvalidate) override final;

		// Implementation of IQuery::Invalidate().
		virtual void SHZ_CALL_TYPE Invalidate() override final;

		// Implementation of IQueryD3D12::GetD3D12QueryHeap().
		virtual ID3D12QueryHeap* SHZ_CALL_TYPE GetD3D12QueryHeap() override final;
