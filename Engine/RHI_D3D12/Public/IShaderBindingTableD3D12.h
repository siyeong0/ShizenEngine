...
#pragma once
 ...
 // \file
 // Definition of the shz::IShaderBindingTableD3D12 interface

#include "Engine/RHI/Interface/IShaderBindingTable.h"
#include "IDeviceContextD3D12.h"
...
namespace shz
{
	...
	struct SHZ_INTERFACE IShaderBindingTableD3D12 : public IShaderBindingTable
	{
		...
		virtual const D3D12_DISPATCH_RAYS_DESC & GetD3D12BindingTable() const = 0;
	};
