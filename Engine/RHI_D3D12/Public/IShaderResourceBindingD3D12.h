...
#pragma once
 ...
 // \file
 // Definition of the shz::IShaderResourceBindingD3D12 interface and related data structures
...
namespace shz
{
	...
	struct SHZ_INTERFACE IShaderResourceBindingD3D12 : public IShaderResourceBinding
	{
