...
#pragma once
 ...
 // \file
 // Definition of the shz::IPipelineStateD3D12 interface
...
namespace shz
{
	...
	struct SHZ_INTERFACE IPipelineStateD3D12 : public IPipelineState
	{
		...
		// The method does **NOT** increment the reference counter of the returned object,
		// so Release() **must not** be called.
		virtual ID3D12StateObject* GetD3D12StateObject() const = 0;
