...
#pragma once
 ...
 // \file
 // Definition of the shz::IQueryD3D12 interface
...
namespace shz
{
	...
	struct SHZ_INTERFACE IQueryD3D12 : public IQuery
	{
		...
		//                       shz::QUERY_TYPE_DURATION, in which case allowed values are 0 for the
		//                       beginning timestamp query, and 1 for the ending query.
		// \return the index of a query object in Direct3D12 query heap
		virtual uint32 GetQueryHeapIndex(uint32 QueryId) const = 0;
	};
