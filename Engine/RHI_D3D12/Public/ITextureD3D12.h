...
#pragma once
 ...
 // \file
 // Definition of the shz::ITextureD3D12 interface
...
namespace shz
{
	...
	struct SHZ_INTERFACE ITextureD3D12 : public ITexture
	{
		...
		// If the state is unknown to the engine (shz::RESOURCE_STATE_UNKNOWN),
