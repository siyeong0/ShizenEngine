...
{
	// ============================================================================
	// RenderResourceCache (Value-based, hash-key only)
	//
	// - Stores TRenderData as plain value in an unordered_map.
	// - KeyType is an already-hashed key (uint64).
	// - Acquire returns pointer (const/non-const). nullptr if not found.
	// - Cache knows NOTHING about AssetID / hashing rules.
	// ============================================================================
