...
#pragma once
 ...
 // \file
 // Defines shz::IFileStream interface
...
namespace shz
{
	...
	struct SHZ_INTERFACE IFileStream : public IObject
	{
		// Reads data from the stream
		virtual bool Read(void* Data, size_t BufferSize) = 0;

		virtual void ReadBlob(IDataBlob* pData) = 0;
		...
		virtual bool SetPos(size_t Offset, int Origin) = 0;
