...
namespace shz
{
	...
	struct IObject
	{
		...
		virtual void SHZ_CALL_TYPE QueryInterface(const INTERFACE_ID& IID, IObject** ppInterface) = 0;
		...
		virtual ReferenceCounterValueType SHZ_CALL_TYPE AddRef() = 0;
		...
		virtual ReferenceCounterValueType SHZ_CALL_TYPE Release() = 0;
		...
		virtual IReferenceCounters* SHZ_CALL_TYPE GetReferenceCounters() const = 0;
	};
