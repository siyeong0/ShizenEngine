...
#pragma once
 ...
 // \file
 // Defines shz::IDataBlob interface
...
namespace shz
{
	...
	// Binary data blob
	struct SHZ_INTERFACE IDataBlob : public IObject
	{
		...
		virtual void* GetDataPtr(size_t Offset = 0) = 0;

		// Returns const pointer to the internal data buffer
		virtual const void* GetConstDataPtr(size_t Offset = 0) const = 0;
