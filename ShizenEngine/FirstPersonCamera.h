...
#include "Engine/Core/Runtime/Public/InputController.h"
...
namespace shz
{
	...
	public:
		...
		float3 GetWorldRight() const { return float3(m_ViewMatrix._m00, m_ViewMatrix._m10, m_ViewMatrix._m20); }
		float3 GetWorldUp()    const { return float3(m_ViewMatrix._m01, m_ViewMatrix._m11, m_ViewMatrix._m21); }
		float3 GetWorldAhead() const { return float3(m_ViewMatrix._m02, m_ViewMatrix._m12, m_ViewMatrix._m22); }
