...
{
    float4x4 MVP = mul(g_ObjectCB.World, g_ShaderCB.ViewProj);
    ...
    VSOut.Depth01 = NdcZToDepth01(ndcZ);

    VSOut.WorldN = normalize(mul(VSIn.Normal, g_ObjectCB.WorldInvertTranspose));
}
