...
#include "Tutorial05_RenderTarget.h"
...
#include "Engine/GraphicsTools/Public/CommonlyUsedStates.h"
...
namespace shz
{
    ...
    void Tutorial12_RenderTarget::CreateRenderTargetPSO()
    {
        ...
        RefCntAutoPtr<IShader> pRTVS;
        {
            ...
            ShaderCI.FilePath = "Assets/rendertarget.vsh";
        ...
        RefCntAutoPtr<IShader> pRTPS;
        {
            ...
            ShaderCI.FilePath = "Assets/rendertarget.psh";
    ...
    void Tutorial12_RenderTarget::Render()
    {
...

        {
            ...
            CBConstants->UVPreTransformInv = m_UVPreTransformMatrix.Inversed();
        }
    ...
    void Tutorial12_RenderTarget::Update(double CurrTime, double ElapsedTime, bool DoUpdateUI)
    {
        ...
        // Apply rotation
        float4x4 CubeModelTransform = float4x4::RotationY(static_cast<float>(CurrTime) * 1.0f) * float4x4::RotationX(-PI * 0.1f);
        ...
        m_UVPreTransformMatrix = float2x2{ SrfPreTransform._m00, SrfPreTransform._m01, SrfPreTransform._m10, SrfPreTransform._m11 };
